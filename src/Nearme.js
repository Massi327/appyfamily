...
export default function Nearme(){
    ...
    const cardnea = [
        ...
        {   key: 5001,
            ...
            data: 'SOON',
            distance: '1.5km',
            dataStart:moment('2023-01-31, 17:00','YYYY-MM-DD, hh:mm'),
            dataEnd:moment('2023-01-31, 18:00','YYYY-MM-DD, hh:mm'),
            address:'173 Balmore Street, NR3 3TX, UK',
            host:'Hosted by BabyGym',
            about:'Ready to play soccer?',
            categoria: 'Sport',
            img: 'imgcard4',
            partecipo: 'false',
            property: 'Esterno'
        ...
        {   key: 5002,
            ...
            data:'SOON',
            distance: '3.4km',
            dataStart:moment('2023-02-05, 17:00','YYYY-MM-DD, hh:mm'),
            dataEnd:moment('2023-02-05, 20:00','YYYY-MM-DD, hh:mm'),
            address:'113 Flams Close, CB4 2TY, UK',
            host:'Hosted by Gina Martin',
            about:'A fantastic picnic in the Shire, Middle Earth',
            categoria: 'Other',
            img: 'imgcard1',
            partecipo: 'false',
            property: 'Esterno'
        ...
        {   key: 5003,
            ...
            about:'Damien Chazelle signs the direction of a melancholy and dreamy musical in which an era of cinema that is no more celebrated. Justin Hurwitz\'s fantastic score gives even more value to a film enhanced by the wonderful acting performances of Emma Stone and Ryan Gosling.',
            categoria: 'Music',
            img: 'imgcard2',
            partecipo: 'false',
            property: 'Esterno'
